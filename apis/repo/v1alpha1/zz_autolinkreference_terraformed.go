...
func (tr *AutolinkReference) GetObservation() (map[string]any, error) {
...
func (tr *AutolinkReference) SetObservation(obs map[string]any) error {
...
func (tr *AutolinkReference) GetParameters() (map[string]any, error) {
...
func (tr *AutolinkReference) SetParameters(params map[string]any) error {
...
// GetInitParameters of this AutolinkReference
func (tr *AutolinkReference) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AutolinkReference
func (tr *AutolinkReference) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
