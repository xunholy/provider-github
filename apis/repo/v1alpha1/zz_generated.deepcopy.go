...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutolinkReferenceInitParameters) DeepCopyInto(out *AutolinkReferenceInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutolinkReferenceInitParameters.
func (in *AutolinkReferenceInitParameters) DeepCopy() *AutolinkReferenceInitParameters {
	if in == nil {
		return nil
	}
	out := new(AutolinkReferenceInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LabelsInitParameters) DeepCopyInto(out *LabelsInitParameters) {
	*out = *in
	if in.Label != nil {
		...
		*out = make([]LabelsLabelInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LabelsLabelInitParameters) DeepCopyInto(out *LabelsLabelInitParameters) {
	*out = *in
	if in.Color != nil {
		in, out := &in.Color, &out.Color
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LabelsLabelInitParameters.
func (in *LabelsLabelInitParameters) DeepCopy() *LabelsLabelInitParameters {
	if in == nil {
		return nil
	}
	out := new(LabelsLabelInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LabelsLabelObservation) DeepCopyInto(out *LabelsLabelObservation) {
	*out = *in
	if in.Color != nil {
		in, out := &in.Color, &out.Color
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LabelsLabelObservation.
func (in *LabelsLabelObservation) DeepCopy() *LabelsLabelObservation {
	if in == nil {
		return nil
	}
	out := new(LabelsLabelObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LabelsLabelParameters) DeepCopyInto(out *LabelsLabelParameters) {
	*out = *in
	if in.Color != nil {
		in, out := &in.Color, &out.Color
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LabelsLabelParameters.
func (in *LabelsLabelParameters) DeepCopy() *LabelsLabelParameters {
	if in == nil {
		return nil
	}
	out := new(LabelsLabelParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LabelsObservation) DeepCopyInto(out *LabelsObservation) {
	*out = *in
	...
	if in.Label != nil {
		in, out := &in.Label, &out.Label
		*out = make([]LabelsLabelObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LabelsParameters) DeepCopyInto(out *LabelsParameters) {
	*out = *in
	if in.Label != nil {
		in, out := &in.Label, &out.Label
		*out = make([]LabelsLabelParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PullRequestInitParameters) DeepCopyInto(out *PullRequestInitParameters) {
	*out = *in
	...
	if in.BaseRefRef != nil {
		in, out := &in.BaseRefRef, &out.BaseRefRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.BaseRefSelector != nil {
		in, out := &in.BaseRefSelector, &out.BaseRefSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
