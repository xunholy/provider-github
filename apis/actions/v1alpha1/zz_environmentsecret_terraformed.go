...
func (tr *EnvironmentSecret) GetObservation() (map[string]any, error) {
...
func (tr *EnvironmentSecret) SetObservation(obs map[string]any) error {
...
func (tr *EnvironmentSecret) GetParameters() (map[string]any, error) {
...
func (tr *EnvironmentSecret) SetParameters(params map[string]any) error {
...
// GetInitParameters of this EnvironmentSecret
func (tr *EnvironmentSecret) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this EnvironmentSecret
func (tr *EnvironmentSecret) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
