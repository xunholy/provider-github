...
// GetInitParameters of this Members
func (tr *Members) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Members
func (tr *Members) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
